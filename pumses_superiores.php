<?php
/**
 * pumses_superiores.php - Página dinámica de videos Pumses Superiores
 */

require __DIR__ . '/php/config.php';

$seccion = 'pumses_superiores';
$titulo_pagina = 'Pumses Superiores';
$titulo_seccion = 'Pumses Superiores';
